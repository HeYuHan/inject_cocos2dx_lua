...
cc.exports.gt = {
	...
	-- 是否经过了更新，默认为false，如果进入了updateScene,就改成true
	isUpdate = false,
...
gt.fitScaleX = cc.Director:getInstance():getVisibleSize().width / 1280
gt.fitScaleY = cc.Director:getInstance():getVisibleSize().height / 720
